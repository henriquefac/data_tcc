...
# remover ruídos
clean_noise_audio:io.BytesIO = remove_noise.denoise_audioIO(processed_audio)


# arquivo de saída

output_path = test_audio_dir.create_file_path(f"{file_name}_preprocessed_denoissed", "wav")
